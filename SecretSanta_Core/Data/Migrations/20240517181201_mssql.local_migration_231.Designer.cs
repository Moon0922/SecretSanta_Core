...
namespace SecretSanta_Core.Migrations
{
    ...
    [Migration("20240517181201_mssql.local_migration_231")]
    partial class mssqllocal_migration_231
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecretSanta_Core.Data.TblDonationArchive", b =>
                {
                    b.Property<decimal>("DonAmount")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<DateTime?>("DonDateTime")
                        .HasColumnType("datetime");

                    b.Property<string>("DonNumber")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("nvarchar(40)");

                    b.Property<int>("DonRecipientNum")
                        .HasColumnType("int");

                    b.Property<int?>("Year")
                        .HasColumnType("int");

                    b.ToTable("tblDonations_archive", (string)null);
                });
            ...
            modelBuilder.Entity("SecretSanta_Core.Data.TblFamilyMemberArchive", b =>
                {
                    b.Property<int>("FamilyMemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tblFamilyMember_archive", (string)null);
                });

            modelBuilder.Entity("SecretSanta_Core.Data.TblHeartArchive", b =>
                {
                    b.Property<int>("Age")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GiftCountInOut")
                        .IsRequired()
                        .HasMaxLength(2)
                        .HasColumnType("nvarchar(2)");
                    ...
                    b.Property<bool>("HeartIsActive")
                        .HasColumnType("bit");

                    b.Property<int>("LastSponsorID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("tblHeart_archive", (string)null);
                });
            ...
            modelBuilder.Entity("SecretSanta_Core.Data.TblLetterSantaArchive", b =>
                {
                    b.Property<int>("LetterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("CalFresh")
                        .HasColumnType("bit");

                    b.Property<bool?>("Calworks")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("DifferentLetter")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("FirstNeedTypeId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("FosterYouth")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("FriendFamily")
                        .HasColumnType("bit");

                    b.Property<bool?>("FullTime")
                        .HasColumnType("bit");

                    b.Property<bool?>("Grandparent")
                        .HasColumnType("bit");

                    b.Property<bool?>("HouseholdLetter")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("OtherEmployment")
                        .HasColumnType("bit");

                    b.Property<string>("OtherHear")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<bool?>("OutsideHouseholdLetter")
                        .HasColumnType("bit");

                    b.Property<bool?>("Over65")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("SantaLetterCode")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("SecondNeedTypeId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<bool?>("SingleDad")
                        .HasColumnType("bit");

                    b.Property<bool?>("SingleMom")
                        .HasColumnType("bit");

                    b.Property<bool?>("SocialSecurity")
                        .HasColumnType("bit");

                    b.Property<string>("ThirdNeedTypeId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<bool?>("Under19")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("VolunteerCenter")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("twooneone")
                        .HasColumnType("bit");

                    b.HasKey("LetterId")
                        .HasName("pk_Santa_archive");

                    b.ToTable("tblLetterSanta_archive", (string)null);
                });
            ...
            modelBuilder.Entity("SecretSanta_Core.Data.TblLetterStatusArchive", b =>
                {
                    b.Property<int>("LetterStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblLetterStatus_archive", (string)null);
                });
            ...
            modelBuilder.Entity("SecretSanta_Core.Data.TblLetterStatusArchive", b =>
                {
                    b.HasOne("SecretSanta_Core.Data.TblLetterSantaArchive", "Letter")
                        .WithMany("TblLetterStatusArchives")
                        .HasForeignKey("LetterId")
                        .IsRequired()
            ...
            modelBuilder.Entity("SecretSanta_Core.Data.TblLetterSantaArchive", b =>
                {
                    b.Navigation("TblLetterStatusArchives");
                });
